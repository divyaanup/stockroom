    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Everyone can access to products -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                @can('create', App\Models\Product::class)
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('products.create')" :active="request()->routeIs('create')">
                        Add Product
                        </x-nav-link>
                    </div>
                @endcan
                @can('import', App\Models\Product::class)
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('products.import')" :active="request()->routeIs('import')">
                        Import Product
                        </x-nav-link>
                    </div>
                @endcan
                @can('orders', App\Models\Order::class)
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('orders.index')" :active="request()->routeIs('index')">
                        Orders
                        </x-nav-link>
                    </div>
                @endcan
